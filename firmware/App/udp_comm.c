...
void udp_motor_type2raw_motor_type(udp_motor_send_t *udp_motor_send, motor_send_data_t *raw_motor_send)
{
...
void raw_motor_type2udp_motor_type(udp_motor_receive_t *udp_motor_receive, motor_receive_data_t *raw_motor_receive)
{
